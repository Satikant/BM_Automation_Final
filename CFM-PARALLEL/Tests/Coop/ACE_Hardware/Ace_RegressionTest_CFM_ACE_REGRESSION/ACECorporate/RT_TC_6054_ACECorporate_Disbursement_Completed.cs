...
namespace CFMAutomation.Tests.Ace_RegressionTest_CFM_ACE_REGRESSION.BrandMuscleAdmin
{
    ...
    public class RT_TC_6054_ACECorporate_Disbursement:Base
    {
        public string claimID = string.Empty;

        //[Test]
        //public void RT_TC_6054_ACECorporate_Disbursement_Completed()
        //{
        //    //Base bs1 = new Base();
        //    Driver=OpenBrowser();
        ...
        public void RT_TC_DisbursementCompletedAndVerifyClaimStatus()
        {
