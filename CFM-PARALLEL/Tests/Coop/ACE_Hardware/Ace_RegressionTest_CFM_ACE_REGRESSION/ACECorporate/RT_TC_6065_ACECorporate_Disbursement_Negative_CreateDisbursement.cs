...
namespace CFMAutomation.Tests.Ace_RegressionTest_CFM_ACE_REGRESSION.CFMIndependent
{
    ...
    public class RT_TC_6065_ACECorporate_Disbursement_Negative:Base
    {
        [Test]
        public void RT_TC_LME_Disbursement_Negative_CloneDisbursement()
        {
            ...
            try
            {
                ...
                disbursement_Negative.Disbursement_Negative_LeftNavValidation("ACECorporate");
