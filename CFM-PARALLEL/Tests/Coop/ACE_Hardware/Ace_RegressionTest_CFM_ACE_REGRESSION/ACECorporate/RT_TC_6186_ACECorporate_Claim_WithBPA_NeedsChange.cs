...
//    public class RT_TC_6186_ACECorporate_Claim
//    {
//        public string bpaID = string.Empty;
//        public string claimID = string.Empty;

//        [Test]
//        public void RT_TC_6186_ACECorporate_Claim_WithBPA_NeedsChange()
//        {
//            //Base bs = new Base();
//            Driver=OpenBrowser();
...
//            claim_PerformAction.ACE_Claim_PerformAction(claimID, "Needs Change", "10");
//                            CommonUtilities.Logout(Driver);       Driver.Quit();;
//        }
//    }
//}