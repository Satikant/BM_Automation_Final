...
//    public class RT_TC_7566_ACECorporate_Claim
//    {
//        public string bpaID = string.Empty;
//        public string claimID = string.Empty;

//        [Test]
//        public void RT_TC_7566_ACECorporate_Claim_WithBPA_Hold()
//        {
//            //Base bs = new Base();
//            Driver=OpenBrowser();
...
//            claim_PerformAction.ACE_Claim_PerformAction(claimID, "Hold", "36");
//                            CommonUtilities.Logout(Driver);       Driver.Quit();;
//        }
//    }
//}