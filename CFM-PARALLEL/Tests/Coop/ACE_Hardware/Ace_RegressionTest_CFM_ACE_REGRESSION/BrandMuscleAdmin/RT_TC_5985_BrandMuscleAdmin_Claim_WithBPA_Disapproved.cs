...
namespace CFMAutomation.Tests.Ace_RegressionTest_CFM_ACE_REGRESSION.BrandMuscleAdmin
{
    ...
    public class RT_TC_5985_BrandMuscleAdmin_Claim:Base
    {
        ...
        public void RT_TC_BrandMuscleAdmin_Claim_WithBPA_Disapproved()
        {
...
CommonUtilities.Logout(Driver);       Driver.Quit();
                ...
                claim_PerformAction.ACE_Claim_PerformAction(claimID, "Deny");
CommonUtilities.Logout(Driver);       Driver.Quit();
            }
            catch (Exception ex)
            {
