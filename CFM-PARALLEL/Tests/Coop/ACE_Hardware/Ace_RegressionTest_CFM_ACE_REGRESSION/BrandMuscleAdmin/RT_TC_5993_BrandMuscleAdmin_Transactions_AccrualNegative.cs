...
namespace CFMAutomation.Tests.Ace_RegressionTest_CFM_ACE_REGRESSION.BrandMuscleAdmin
{
    ...
    public class RT_TC_5993_Transactions:Base
    {
        [Test, NonParallelizable]
        public void RT_TC_BrandMuscleAdmin_Transactions_AccrualNegative()
        {
            ...
            try
            {
                ...
                transaction_Accrual.Transaction_AllocateAccruals("Flat", Parameters.Ace_AccrualNegative_Amount);
                //Transaction_Adjustment.Transaction_AllocateAdjustment();
