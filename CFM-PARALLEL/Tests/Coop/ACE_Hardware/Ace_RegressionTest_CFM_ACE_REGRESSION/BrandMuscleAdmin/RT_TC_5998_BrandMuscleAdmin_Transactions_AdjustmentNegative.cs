...
namespace CFMAutomation.Tests.Ace_RegressionTest_CFM_ACE_REGRESSION.BrandMuscleAdmin
{
    ...
    public class RT_TC_5998_Transactions:Base
    {
        [Test, NonParallelizable]
        public void RT_TC_BrandMuscleAdmin_Transactions_AdjustmentNegative() {
            ...
            try
            {
                ...
                transaction_Adjustment.Transaction_AllocateAdjustment("Flat", Parameters.Ace_AccrualNegative_Amount);
