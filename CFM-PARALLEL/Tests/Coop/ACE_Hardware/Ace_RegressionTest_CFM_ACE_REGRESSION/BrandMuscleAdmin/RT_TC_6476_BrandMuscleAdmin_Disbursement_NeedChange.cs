...
namespace CFMAutomation.Tests.Ace_RegressionTest_CFM_ACE_REGRESSION.BrandMuscleAdmin
{
    ...
    public class RT_TC_6476_BrandMuscleAdmin_Disbursement:Base
    {
        public string claimID = string.Empty;

        [Test]
        public void RT_TC_BrandMuscleAdmin_Disbursement_NeedChange()
        {
            ...
            try
            {
                ...
                Console.WriteLine("Claim Status Changed to Approved After disbursement Changed to NeedChange");
                CommonUtilities.Logout(Driver);
                Driver.Quit();
            }
            catch (Exception ex)
