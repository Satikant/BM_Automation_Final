...
namespace CFMAutomation.Tests.Ace_RegressionTest_CFM_ACE_REGRESSION.CFMChainHQ
{
    ...
    public class RT_TC_1_CFMChainHQ_ClaimProgramOverdrawnDeny:Base
    {
        public string claimID = string.Empty;
        [Test, NonParallelizable]
        public void RT_TC_CFMChainHQ_ClaimProgramOverdrawn_Deny()
        {
...
CommonUtilities.Logout(Driver);       Driver.Quit();
                ...
                claim_PerformAction2.ACE_Claim_PerformActionOD(claimID, "Deny", "26", AmountBeforeApproval, expectation: "DenyValue");
CommonUtilities.Logout(Driver);       Driver.Quit();
                ...
                Assert.AreEqual(AmountAfterApproval, (AmountBeforeApproval));
CommonUtilities.Logout(Driver);       Driver.Quit();
            }
            catch (Exception ex)
            {
